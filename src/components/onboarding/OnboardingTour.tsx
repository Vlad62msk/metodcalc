...
const STEPS = [
  ...
  },
  {
    ...
    title: 'Меню действий',
    content: 'Через это меню вы можете открыть библиотеку шаблонов, управлять версиями проекта, поделиться сметой по ссылке и перейти на страницу разработчика.',
  },
  {
