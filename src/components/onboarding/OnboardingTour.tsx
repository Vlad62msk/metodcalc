...
const STEPS = [
  ...
  },
  {
    ...
    content: 'Добавляйте элементы сметы вручную или из библиотеки обучающих форматов. Группируйте связанные позиции в контейнеры.',
  },
  {
    target: '[data-tour="library"]',
    title: 'Меню действий',
    content: 'Через это меню вы можете открыть библиотеку обучающих форматов, управлять версиями проекта, поделиться сметой по ссылке и перейти на страницу разработчика.',
  },
  {
